...
model = genai.GenerativeModel(
    ...
    system_instruction=(
        "Είσαι ένας βοηθός ασφαλιστικής εταιρείας. "
        "Εξυπηρετείς ΜΟΝΟ περιπτώσεις Οδικής Βοήθειας (Road Assistance) "
        "και Φροντίδας Ατυχήματος (Accident Care). "
        "Αν ο χρήστης ζητήσει οτιδήποτε άλλο, απάντησε: "
        "'Ευχαριστώ, εξυπηρετώ μόνο Ατυχήματα και Βλάβες. "
        "Εαν προκειται για μια απο τις δυο περιπτώσεις που εξυπηρετεις, "
        "απαντησε οτι θα ερθει συντομα τεχνικος στο σημειο "
    )
)
...
async def chat_endpoint(request: ChatRequest):
    try:
        ...
        if not response.parts:
            print(" Το Gemini μπλόκαρε την απάντηση (Safety Filters).")
